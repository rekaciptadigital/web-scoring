        ...
        <div className="text-center">
          <label htmlFor="button-upload-bg-image">
            <Button tag="span" color="primary">
              <i className="bx bx-image-add font-size-18 align-middle" /> Ganti Latar
            </Button>
            <input
              type="file"
          ...
          <p className="mt-3 mb-0">Unggah gambar dengan resolusi tinggi maks. besar file 5mb, format PNG/JPEG</p>
        </div>
      </div>
    );
  }
