...
function useDownloadScoresheetSelection(eventCategoryId) {
  ...
  const download = async (sessionNumber, customOptions) => {
    ...
    const getFunction = () => {
      return ScoringService.getScoresheetEliminationSelectionDownloadUrl({
...
export { useDownloadScoresheetSelection };
